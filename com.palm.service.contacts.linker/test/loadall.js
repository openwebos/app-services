...
/*global MojoLoader, palmGetResource, include, IMPORTS, require:true */
...
if (!loadall) {
	loadall = true;
	var fs = require('fs');	
	var manifest = JSON.parse(fs.readFileSync("sources.json")),
		i,
		entry,
		lib;
	...
	webos.include("test/contactGenerator.js");
