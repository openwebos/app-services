...
#ifndef POPVALIDATIONLISTENER_H_
#define POPVALIDATIONLISTENER_H_

#include "core/MojRefCount.h"
#include <string>

class PopValidationListener : public MojRefCounted
{
public:
	typedef enum {
		VALIDATED = 0,
		...
		EAS_SECURITY_POLICY_NOT_SUPPORTED = 505,
...
#endif /* POPVALIDATIONLISTENER_H_ */
