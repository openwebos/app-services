...
#ifndef QUOTEDPRINTABLEENCODEROUTPUTSTREAM_H_
#define QUOTEDPRINTABLEENCODEROUTPUTSTREAM_H_

#include <glib.h>
#include "stream/BaseOutputStream.h"
#include <boost/shared_array.hpp>

class QuotedPrintableEncoderOutputStream : public ChainedOutputStream
{
...
#endif /*QUOTEDPRINTABLEENCODEROUTPUTSTREAM_H_*/
