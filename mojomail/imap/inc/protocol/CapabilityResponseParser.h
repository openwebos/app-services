...
#ifndef CAPABILITYRESPONSEPARSER_H_
#define CAPABILITYRESPONSEPARSER_H_

#include "protocol/ImapResponseParser.h"

class CapabilityResponseParser : public ImapResponseParser
{
public:
...
#endif /*CAPABILITYRESPONSEPARSER_H_*/
