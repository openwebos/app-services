...
#ifndef IMAPVALIDATIONLISTENER_H_
#define IMAPVALIDATIONLISTENER_H_

#include "core/MojRefCount.h"

class ImapValidator;

class ImapValidationListener
{
public:
	...
	virtual ~ImapValidationListener() { };

	virtual void ValidationDone(ImapValidator* validator) = 0;
	//virtual void Failure(ValidationErrorCode errorCode, std::string errorText) = 0;
};

#endif /* IMAPVALIDATIONLISTENER_H_ */
