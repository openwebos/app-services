...
#ifndef IMAPBUSDISPATCHERCOMMAND_H_
#define IMAPBUSDISPATCHERCOMMAND_H_

#include "commands/ImapCommand.h"

class ImapBusDispatcher;

class ImapBusDispatcherCommand : public ImapCommand
{
public:
...
#endif /* IMAPBUSDISPATCHERCOMMAND_H_ */
